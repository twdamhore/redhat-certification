...
echo ""
cd "/home/examuser/rhcsa-lab" 2>/dev/null

show_task "5.1" "2" "As examuser, create '~examuser/rhcsa-lab/examuser_was_here.txt' containing 'Created by examuser'"
...
show_task "5.2" "3" "As examuser with sudo, create '~examuser/rhcsa-lab/sudo_test.txt' owned by root containing 'Created with sudo'"
...
show_task "5.3" "2" "As examuser, create '~examuser/rhcsa-lab/shared_workspace/team_file.txt' owned by examuser:developers containing 'Team collaboration file'"
...
show_task "5.4" "3" "As examuser, save 'whoami' and 'id' output to '~examuser/rhcsa-lab/reports/current_user.txt'"
